import { defineComponent, ref, reactive ,watchEffect,onMounted,nextTick} from 'vue';
...
export default defineComponent({
  ...
  setup(props: ModalProps, ctx) {
    ...
    // watchEffect(() => props.widgetShowProps,(state, prevState)=>{
